...
export interface CreatePropertyRequest
  extends Omit<CreatePropertyDto, "user_id"> {
  user_id?: string;
}
...
export const propertyService = {
  async create(data: CreatePropertyRequest): Promise<Property> {
    try {
      const response = await api.propertyControllerCreate(
      ...
      if (typeof error === "object" && error !== null && "response" in error) {
        ...
        if (axiosError.response?.data) {
          const apiError = new Error(
            axiosError.response.data.message ?? "Tạo tin đăng thất bại",
          );
        ...
        if (axiosError.response?.data) {
          const apiError = new Error(
            axiosError.response.data.message ??
              "Lấy danh sách tin đăng thất bại",
          );
          Object.assign(apiError, { response: axiosError.response });
          throw apiError;
        }
    ...
    try {
      ...
      if (typeof error === "object" && error !== null && "response" in error) {
        ...
        if (axiosError.response?.data) {
          const apiError = new Error(
            axiosError.response.data.message ??
              "Lấy thông tin tin đăng thất bại",
          );
          Object.assign(apiError, { response: axiosError.response });
          throw apiError;
        }
  ...
  async update(id: string, data: UpdatePropertyRequest): Promise<Property> {
    try {
      ...
      if (typeof error === "object" && error !== null && "response" in error) {
        ...
        if (axiosError.response?.data) {
          const apiError = new Error(
            axiosError.response.data.message ?? "Cập nhật tin đăng thất bại",
          );
          Object.assign(apiError, { response: axiosError.response });
          throw apiError;
        }
  ...
  async delete(id: string): Promise<void> {
    try {
      ...
      if (typeof error === "object" && error !== null && "response" in error) {
        ...
        if (axiosError.response?.data) {
          const apiError = new Error(
            axiosError.response.data.message ?? "Xóa tin đăng thất bại",
          );
          Object.assign(apiError, { response: axiosError.response });
          throw apiError;
        }
