...
export default function PropertyCard({ property }: { property: Property }) {
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition-all duration-500 hover:border-red-200">
      {property.isVerified && (
      ...
      <div className="flex flex-col">
        <div className="relative flex w-full overflow-hidden">
          <div className="relative h-[240px] w-[60%] flex-shrink-0">
            <Image
              src={"/images/landingpage/apartment/apart-1.jpg"}
              alt={property.title}
              fill
        ...
        <div className="flex items-center justify-between border-t border-gray-200 p-4">
          ...
          <div className="flex items-center gap-3">
            <Button type="primary">
              ...
              <span>0985 009 ***</span>
              <span className="text-xs opacity-90">- Hiển số</span>
            </Button>
            <Button>
              <Heart size={16} />
            </Button>
